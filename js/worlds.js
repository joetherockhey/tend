...
const Worlds = (function () {
  ...
  /* ======================================================================
     ...
     i % 4, so the ground you start on is Summer and what you open up runs
     Autumn, Winter, Spring and round again.
     ...
     stronger opinion than a mix can carry (red leaves in autumn, frost in
     winter).
  ...
  const SEASONS = [
    /* The ground you start on. Kept close to plain green - a strong summer
       yellow on the first thing anyone sees read as sickly, not sunny - and
       nothing drifts through it. */
    { id: 'summer', label: 'Summer', icon: '\u{2600}\u{FE0F}',
      tint: [150, 205, 110], tintStrength: 0.06,
      detail: { tuft: '#6fb558', tuft2: '#4b8a36', patch: '#dcefc4' } },
    /* The first ground you buy: orange and crimson, with leaves coming down. */
    { id: 'autumn', label: 'Autumn', icon: '\u{1F342}',
      tint: [222, 118, 26], tintStrength: 0.4,
      detail: { tuft: '#d0612b', tuft2: '#a3262f', pebble: '#dcc2a4', patch: '#e59a5c', edge: '#8e3b2a' } },
  ...
  const OCEAN_SEASONS = [
    { label: 'Warm Current', tint: [120, 210, 170], tintStrength: 0.07,
      detail: { tuft: '#6fc6b0', tuft2: '#489a88', patch: '#d2eedc' } },
