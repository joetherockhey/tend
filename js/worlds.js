...
const Worlds = (function () {
  ...
  /* ======================================================================
    ...
    const PLANT_VARIETIES = [
      ...
      { name: 'Mint', plant: '<rect x="6" y="11" width="1" height="3" fill="#3f9142"/><rect x="3" y="7" width="4" height="4" fill="#6bc06e"/><rect x="7" y="6" width="4" height="4" fill="#4fa754"/><rect x="5" y="3" width="4" height="3" fill="#6bc06e"/>' },
      ...
      { name: 'Creeping Thyme', plant: '<rect x="2" y="10" width="10" height="3" fill="#4c8c3c"/><rect x="3" y="8" width="3" height="2" fill="#6bc06e"/><rect x="8" y="8" width="3" height="2" fill="#6bc06e"/><rect x="5" y="7" width="2" height="2" fill="#9b8ad4"/>' },
      { name: 'Money Tree', plant: '<rect x="6" y="9" width="2" height="5" fill="#8a5a2e"/><rect x="5" y="10" width="1" height="2" fill="#6b4423"/><rect x="8" y="10" width="1" height="2" fill="#6b4423"/><rect x="2" y="3" width="10" height="6" fill="#3f9142"/><rect x="4" y="2" width="6" height="1" fill="#6bc06e"/>' },
      { name: 'Fiddle-leaf Fig', plant: '<rect x="6" y="10" width="1" height="4" fill="#6b4423"/><rect x="2" y="6" width="4" height="4" fill="#2f7a34"/><rect x="8" y="5" width="4" height="4" fill="#3f9142"/><rect x="4" y="2" width="5" height="4" fill="#2f7a34"/>' }
    ];
  ...
  const OCEAN_PLANTS = [
    ...
    { name: 'Staghorn Coral', plant: '<rect x="6" y="9" width="2" height="5" fill="#c96a58"/><rect x="3" y="4" width="2" height="6" fill="#e0705a"/><rect x="9" y="3" width="2" height="7" fill="#e0705a"/><rect x="5" y="2" width="2" height="7" fill="#f0906a"/><rect x="2" y="2" width="2" height="2" fill="#ffb08c"/><rect x="10" y="1" width="2" height="2" fill="#ffb08c"/>' },
    { name: 'Sea Fern', plant: '<rect x="6" y="2" width="1" height="12" fill="#2f6b46"/><rect x="2" y="4" width="3" height="1" fill="#56b07a"/><rect x="2" y="7" width="3" height="1" fill="#56b07a"/><rect x="2" y="10" width="3" height="1" fill="#56b07a"/><rect x="8" y="5" width="3" height="1" fill="#56b07a"/><rect x="8" y="8" width="3" height="1" fill="#56b07a"/>' },
    { name: 'Creeping Kelp', plant: '<rect x="1" y="8" width="2" height="1" fill="#3f8f5c"/><rect x="0" y="10" width="2" height="1" fill="#2f6b46"/><rect x="11" y="8" width="2" height="1" fill="#3f8f5c"/><rect x="12" y="10" width="2" height="1" fill="#2f6b46"/><rect x="5" y="6" width="4" height="4" fill="#3f8f5c"/>' },
    ...
    { name: 'Kelp Stalks', plant: '<rect x="4" y="1" width="2" height="12" fill="#2f6b46"/><rect x="8" y="1" width="2" height="12" fill="#56b07a"/><rect x="4" y="5" width="2" height="1" fill="#1f4d33"/><rect x="8" y="8" width="2" height="1" fill="#1f4d33"/><rect x="4" y="9" width="2" height="1" fill="#1f4d33"/><rect x="3" y="0" width="2" height="1" fill="#56b07a"/><rect x="9" y="0" width="2" height="1" fill="#56b07a"/>' },
    ...
    { name: 'Sea Squirt Vine', plant: '<rect x="2" y="8" width="4" height="3" fill="#3f8f5c"/><rect x="8" y="7" width="4" height="3" fill="#3f8f5c"/><rect x="5" y="8" width="4" height="4" fill="#eb6834"/><rect x="6" y="6" width="1" height="2" fill="#2f6b46"/><rect x="6" y="9" width="2" height="1" fill="#ffb08c"/>' },
    ...
    { name: 'Sea Lettuce', plant: '<rect x="6" y="11" width="1" height="2" fill="#2f6b46"/><rect x="3" y="6" width="4" height="5" fill="#56b07a"/><rect x="7" y="5" width="4" height="6" fill="#7cc79a"/>' },
    { name: 'Turtle Grass', plant: '<rect x="6" y="10" width="1" height="3" fill="#2f6b46"/><rect x="4" y="4" width="1" height="7" fill="#3f8f5c"/><rect x="6" y="2" width="1" height="9" fill="#56b07a"/><rect x="8" y="5" width="1" height="6" fill="#3f8f5c"/><rect x="10" y="7" width="1" height="4" fill="#7cc79a"/>' },
    { name: 'Sea Whip', plant: '<rect x="6" y="2" width="1" height="11" fill="#e88fa8"/><rect x="5" y="8" width="3" height="1" fill="#e88fa8"/><rect x="3" y="5" width="1" height="6" fill="#d4526b"/><rect x="2" y="9" width="2" height="1" fill="#d4526b"/><rect x="9" y="5" width="1" height="6" fill="#d4526b"/><rect x="9" y="9" width="3" height="1" fill="#d4526b"/>' },
    ...
    { name: 'Ribbon Kelp', plant: '<rect x="4" y="2" width="2" height="11" fill="#2f6b46"/><rect x="7" y="0" width="2" height="13" fill="#3f8f5c"/><rect x="10" y="3" width="2" height="10" fill="#2f6b46"/><rect x="4" y="5" width="2" height="1" fill="#7cc79a"/><rect x="7" y="6" width="2" height="1" fill="#7cc79a"/>' },
    ...
    { name: 'Chimney Sponge', plant: '<rect x="4" y="6" width="3" height="8" fill="#c4aee6"/><rect x="8" y="4" width="3" height="10" fill="#a78bd0"/><rect x="4" y="5" width="3" height="1" fill="#8e6bb0"/><rect x="8" y="3" width="3" height="1" fill="#8e6bb0"/>' },
    ...
    { name: 'Sea Thistle', plant: '<rect x="6" y="8" width="1" height="6" fill="#3f8f5c"/><rect x="4" y="4" width="5" height="4" fill="#8e6bb0"/><rect x="5" y="2" width="1" height="2" fill="#c4aee6"/><rect x="7" y="2" width="1" height="2" fill="#c4aee6"/><rect x="3" y="5" width="1" height="2" fill="#c4aee6"/><rect x="9" y="5" width="1" height="2" fill="#c4aee6"/>' },
    { name: 'Mushroom Coral', plant: '<rect x="6" y="9" width="2" height="5" fill="#f2e2d0"/><rect x="2" y="5" width="10" height="4" fill="#d4526b"/><rect x="3" y="4" width="8" height="1" fill="#e0705a"/><rect x="4" y="7" width="6" height="1" fill="#b04456"/>' },
    { name: 'Glass Sponge', plant: '<rect x="4" y="3" width="2" height="11" fill="#b8e6f2"/><rect x="7" y="5" width="2" height="9" fill="#8fd6e8"/><rect x="4" y="6" width="5" height="1" fill="#f2e2d0"/><rect x="4" y="9" width="5" height="1" fill="#f2e2d0"/><rect x="3" y="2" width="4" height="1" fill="#f2e2d0"/>' }
  ];
