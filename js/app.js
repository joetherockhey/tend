...
const App = (function () {
  ...
  /* The star is the only thing that puts a task on today's plan, so taking it
     off has to redraw the plan as well as the task list - unstarring from the
     plan itself was leaving the row sitting there until you switched pages.
     Nothing else changes: it keeps its place in the plan's running order in
     case it is starred again today, and on the Tasks page it simply drops
     from Priority back into Active. */
